...
import com.example.zuoyefinal.bean.UserInfo;
import com.example.zuoyefinal.database.UserDBHelper;
import com.example.zuoyefinal.util.DateUtil;
import com.example.zuoyefinal.util.ViewUtil;
...
public class LoadActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","18990102 马子桐"};
